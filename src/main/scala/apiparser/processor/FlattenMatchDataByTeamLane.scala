...
class TeamLaneMatchData(
    ...
    val winTeamId: Int = 0,
    val teamOneTopChampionId: Int = 0,
    val teamOneJungleChampionId: Int = 0,
    val teamOneMidChampionId: Int = 0,
    val teamOneCarryChampionId: Int = 0,
    val teamOneSupportChampionId: Int = 0,
    val teamTwoTopChampionId: Int = 0,
    val teamTwoJungleChampionId: Int = 0,
    val teamTwoMidChampionId: Int = 0,
    val teamTwoCarryChampionId: Int = 0,
    val teamTwoSupportChampionId: Int = 0,
) extends BaseModel with Serializable

class FlattenMatchDataByTeamLane extends FlattenedMatchDataProcessor {
